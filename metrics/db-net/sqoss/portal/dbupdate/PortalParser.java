...
public class PortalParser 
{
     ...
     */   
    public PortalParser(PropertiesConfiguration props,Logger logger) 
    {        
        try {
            br_=new BufferedReader(new FileReader((String)props.getString("PORTAL_FILE")));
        }
        catch (IOException e) {
            logger_.fatal("failed to open portals list file:/n"+MyClassUtils.getStackTraceTabbed(e));
            System.exit(-1);
        }        
    }//ProjectParser
