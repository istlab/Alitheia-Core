    ...
    alter table FILE_GROUP 
        drop constraint FKD2AB41DCA11FC705;

    alter table MEASUREMENT 
        drop constraint FK14466F9CDB4C67CF;

    alter table MEASUREMENT 
        drop constraint FK14466F9CA5C4F678;

    alter table MEASUREMENT 
        drop constraint FK14466F9CA639B923;

    alter table MEASUREMENT 
        drop constraint FK14466F9CA11FC705;

    alter table METRIC 
        drop constraint FK8758E9B06161E398;

    alter table METRIC 
        drop constraint FK8758E9B079678179;

    alter table PROJECT_FILE 
        drop constraint FKC3DC4302A11FC705;

    alter table PROJECT_VERSION 
        drop constraint FKC5061D72677D0179;

    drop table FILE_GROUP if exists;

    drop table MEASUREMENT if exists;

    drop table METRIC if exists;

    drop table METRIC_TYPE if exists;

    drop table PLUGIN if exists;

    drop table PROJECT_FILE if exists;

    drop table PROJECT_VERSION if exists;

    drop table STORED_PROJECT if exists;
    ...
    alter table PROJECT_VERSION 
        add constraint FKC5061D72677D0179 
