...
/**
 * The Configurator class holds the configuration information stored in the
 * sqooss.properties
 * 
 */
public class Configurator {
    ...
    private Configurator() {
        ...
        try {
            FileInputStream fis = new FileInputStream(sqoossHome
                    + File.separatorChar + "sqooss.properties");
