...
//		assertThat(builder.toString(), equalTo(expected));
	...
	public void testCreateFrom() throws Exception {
		...
		//call private method
		Whitebox.<StoredProject>invokeMethod(projectsView, "createForm",builder,builder2,storedProject,"action");
		...
		Whitebox.<StoredProject>invokeMethod(projectsView, "createForm",builder,builder2,storedProject,ACT_REQ_SHOW_PROJECT);
		...
		Whitebox.<StoredProject>invokeMethod(projectsView, "createForm",builder,builder2,storedProject,ACT_REQ_ADD_PROJECT);
		...
		Whitebox.<StoredProject>invokeMethod(projectsView, "createForm",builder,builder2,storedProject,ACT_REQ_REM_PROJECT);
