...
public class ProjectsViewTest extends AbstractViewTestBase {
	...
	public void testCreateFrom() throws Exception {
		...
		//call private method
		Whitebox.<StoredProject>invokeMethod(projectsView, "setupForm",builder,storedProject,"action");
		...
		Whitebox.<StoredProject>invokeMethod(projectsView, "setupForm",builder,storedProject,ACT_REQ_SHOW_PROJECT);
		...
		Whitebox.<StoredProject>invokeMethod(projectsView, "setupForm",builder,storedProject,ACT_REQ_ADD_PROJECT);
		...
		Whitebox.<StoredProject>invokeMethod(projectsView, "setupForm",builder,storedProject,ACT_REQ_REM_PROJECT);
