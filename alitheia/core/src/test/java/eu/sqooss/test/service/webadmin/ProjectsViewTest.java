...
public class ProjectsViewTest extends AbstractViewTestBase {
	...
	public void testAddProject() throws Exception {
		...
		//call private method
		StoredProject proj = Whitebox.<StoredProject>invokeMethod(projectsView, "addProject",builder,r,0);
		...
		proj = Whitebox.<StoredProject>invokeMethod(projectsView, "addProject",builder,r,0);
	...
	public void testRemoveProject() throws Exception {
		...
		//call private method
		StoredProject proj = Whitebox.<StoredProject>invokeMethod(projectsView, "removeProject",builder,p,0);
		assertThat(proj,nullValue());

		doThrow(new SchedulerException("Test error")).when(scheduler).enqueue(any(Job.class));;
		proj = Whitebox.<StoredProject>invokeMethod(projectsView, "removeProject",builder,p,0);

		//call private method addProject with arguments builder,r,0
		proj = Whitebox.<StoredProject>invokeMethod(projectsView, "removeProject",builder,null,0);
		assertThat(proj, nullValue());
	}
	...
	public void testTriggerAllUpdateNode() throws Exception {
		...
		Whitebox.<StoredProject>invokeMethod(projectsView, "triggerAllUpdateNode",builder,p,0);
	...
	public void testSyncPlugin() throws Exception {
		...
		//call private method
		Whitebox.<StoredProject>invokeMethod(projectsView, "syncPlugin",builder,p,"hash");
...
//		assertThat(builder.toString(), equalTo(expected));
	...
	public void testCreateFrom() throws Exception {
		...
		//call private method
		Whitebox.<StoredProject>invokeMethod(projectsView, "createForm",builder,builder2,storedProject,"action",0);
		...
		assertEquals(expected2.replaceAll("\\t|\\n","").replaceAll(" +"," ").replaceAll("> <","><").trim(),builder2.toString().replaceAll("\\t|\\n","").replaceAll(" +"," ").replaceAll("> <","><").trim());
		...
		Whitebox.<StoredProject>invokeMethod(projectsView, "createForm",builder,builder2,storedProject,ACT_REQ_SHOW_PROJECT,0);
		...
		Whitebox.<StoredProject>invokeMethod(projectsView, "createForm",builder,builder2,storedProject,ACT_REQ_ADD_PROJECT,0);
		...
		Whitebox.<StoredProject>invokeMethod(projectsView, "createForm",builder,builder2,storedProject,ACT_REQ_REM_PROJECT,0);
