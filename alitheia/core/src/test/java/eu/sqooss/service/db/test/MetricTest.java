...
public class MetricTest {
	...
	static Metric testObject;

	@BeforeClass
	public static void setUp() {
		testObject = new Metric();
	}
	...
	@Test
	public void testMnemonicGetterSetter()
	{
		//set the value via the setter
		testObject.setMnemonic("testMnemonic");
		
		//Pull out property in order to compare
		String actualValue = Whitebox.<String>getInternalState(testObject, "mnemonic");
		
		//Compare the expected with the actual result
		assertEquals(actualValue,"testMnemonic");
		
		String getValue=  testObject.getMnemonic();
		//Compare the expected with the actual result
		assertEquals(getValue,"testMnemonic");	
	}
