            ...
            */
            ...
            /**
            *  GetUserMessageOfTheDay bean class
            */
        
        public  class GetUserMessageOfTheDay
    ...
    public static class Factory{
        ...
        */
        public static GetUserMessageOfTheDay parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetUserMessageOfTheDay object = new GetUserMessageOfTheDay();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"getUserMessageOfTheDay".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (GetUserMessageOfTheDay)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
