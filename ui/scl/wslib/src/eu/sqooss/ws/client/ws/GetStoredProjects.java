            ...
            */
            ...
            /**
            *  GetStoredProjects bean class
            */
        
        public  class GetStoredProjects
    ...
    public static class Factory{
        ...
        */
        public static GetStoredProjects parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetStoredProjects object = new GetStoredProjects();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"getStoredProjects".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (GetStoredProjects)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
