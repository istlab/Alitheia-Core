            ...
            */
            ...
            /**
            *  RetrieveProjectId bean class
            */
        
        public  class RetrieveProjectId
    ...
    public static class Factory{
        ...
        */
        public static RetrieveProjectId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RetrieveProjectId object = new RetrieveProjectId();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"retrieveProjectId".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (RetrieveProjectId)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
