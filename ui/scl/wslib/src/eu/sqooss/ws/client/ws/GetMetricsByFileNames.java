            ...
            */
            ...
            /**
            *  GetMetricsByFileNames bean class
            */
        
        public  class GetMetricsByFileNames
    ...
    public static class Factory{
        ...
        */
        public static GetMetricsByFileNames parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMetricsByFileNames object = new GetMetricsByFileNames();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"getMetricsByFileNames".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (GetMetricsByFileNames)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
