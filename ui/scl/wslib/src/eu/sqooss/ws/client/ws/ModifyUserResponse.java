    ...
    public static class Factory{
        ...
        */
        public static ModifyUserResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ModifyUserResponse object = new ModifyUserResponse();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"modifyUserResponse".equals(type)){
                        ...
                        return (ModifyUserResponse)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
