            ...
            */
            ...
            /**
            *  RetrieveSelectedMetric bean class
            */
        
        public  class RetrieveSelectedMetric
    ...
    public static class Factory{
        ...
        */
        public static RetrieveSelectedMetric parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RetrieveSelectedMetric object = new RetrieveSelectedMetric();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"retrieveSelectedMetric".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (RetrieveSelectedMetric)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
