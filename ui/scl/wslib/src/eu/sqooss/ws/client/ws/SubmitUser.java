    ...
    public static class Factory{
        ...
        */
        public static SubmitUser parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SubmitUser object = new SubmitUser();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"submitUser".equals(type)){
                        ...
                        return (SubmitUser)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
