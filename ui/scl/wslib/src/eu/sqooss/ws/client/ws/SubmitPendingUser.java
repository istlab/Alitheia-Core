            ...
            */
            ...
            /**
            *  SubmitPendingUser bean class
            */
        
        public  class SubmitPendingUser
    ...
    public static class Factory{
        ...
        */
        public static SubmitPendingUser parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SubmitPendingUser object = new SubmitPendingUser();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"submitPendingUser".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (SubmitPendingUser)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
