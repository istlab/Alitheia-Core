            ...
            */
            ...
            /**
            *  GetFilesByProjectId bean class
            */
        
        public  class GetFilesByProjectId
    ...
    public static class Factory{
        ...
        */
        public static GetFilesByProjectId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetFilesByProjectId object = new GetFilesByProjectId();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"getFilesByProjectId".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (GetFilesByProjectId)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
