            ...
            */
            ...
            /**
            *  GetEvaluatedProjects bean class
            */
        
        public  class GetEvaluatedProjects
    ...
    public static class Factory{
        ...
        */
        public static GetEvaluatedProjects parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetEvaluatedProjects object = new GetEvaluatedProjects();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"getEvaluatedProjects".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (GetEvaluatedProjects)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
