            ...
            */
            ...
            /**
            *  GetMetricsByProjectId bean class
            */
        
        public  class GetMetricsByProjectId
    ...
    public static class Factory{
        ...
        */
        public static GetMetricsByProjectId parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetMetricsByProjectId object = new GetMetricsByProjectId();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"getMetricsByProjectId".equals(type)){
                        //find namespace for the prefix
                        java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                        return (GetMetricsByProjectId)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
