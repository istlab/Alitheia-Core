    ...
    public static class Factory{
        ...
        */
        public static RetrieveFileList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RetrieveFileList object = new RetrieveFileList();
            int event;
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    if (!"retrieveFileList".equals(type)){
                        ...
                        return (RetrieveFileList)eu.sqooss.impl.service.web.services.datatypes.xsd.ExtensionMapper.getTypeObject(
                             nsUri,type,reader);
                      }
